...
Future<void> generate(String current)async{
  var r = await get(Uri.parse('https://restcountries.com/v2/all?fields=name,capital,languages,region,area,flags,currencies'));
  ...
  for (var i in d) {
    ...
    countries.add(world_country(name:i['name'] ,capital:capital ,area:area ,region:region,language:language,currency:currency,flag:Uri.parse(i['flags']['png'])));
    //print(i['name']['common']);
